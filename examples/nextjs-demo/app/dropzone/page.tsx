      ...
      <Card withBorder padding="md">
        <Stack>
          <Dropzone
            onDrop={(f) => {
              setFiles(f);
              notifications.show({ title: 'Dropped', message: `${f.length} file(s)` });
            }}
            onReject={() =>
              notifications.show({
                color: 'red',
                title: 'Rejected',
                message: 'Type or size invalid',
              })
            }
            maxSize={5 * 1024 ** 2}
          ...
          >
            <Group justify="center" p="xl">
              ...
              <Dropzone.Reject>
                <Text c="red">File rejected</Text>
              </Dropzone.Reject>
              <Dropzone.Idle>
                <Text>Drag images, PDFs or CSVs here, or click to pick</Text>
              </Dropzone.Idle>
            </Group>
          </Dropzone>
