            ...
            <Stack key={name} gap={4}>
              ...
              <Group gap={4}>
                {(theme.colors[name] ?? []).map((shade, i) => (
                  // biome-ignore lint/suspicious/noArrayIndexKey: static palette demo
      ...
      <Card withBorder padding="md">
        <Stack>
          ...
          <Text size="sm" c="dimmed">
            primaryColor: <Code>{theme.primaryColor}</Code> | primaryShade: light=
            {String((theme.primaryShade as any).light)} dark=
            {String((theme.primaryShade as any).dark)} | autoContrast: {String(theme.autoContrast)}
          </Text>
          <Group>
          ...
          <Group>
            <ThemeIcon color="mal-brand" size="lg">
              <span>B</span>
            </ThemeIcon>
            <ThemeIcon color="mal-secondary" size="lg">
              <span>S</span>
            </ThemeIcon>
            <ThemeIcon color="mal-success" size="lg">
              <span>✓</span>
            </ThemeIcon>
            <ThemeIcon color="mal-warning" size="lg">
              <span>!</span>
            </ThemeIcon>
            <ThemeIcon color="mal-error" size="lg">
              <span>✕</span>
            </ThemeIcon>
          </Group>
        </Stack>
